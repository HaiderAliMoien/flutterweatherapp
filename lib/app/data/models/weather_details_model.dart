...
class Astro {
  ...
  factory Astro.fromJson(Map<String, dynamic> json) => Astro(
    ...
    isMoonUp: json['is_moon_up'] as num? ?? 0,
    isSunUp: json['is_sun_up'] as num? ?? 0,
  );
...
class Day {
  ...
  factory Day.fromJson(Map<String, dynamic> json) => Day(
    ...
    totalprecipMm: json['totalprecip_mm'] as num? ?? 0,
    totalprecipIn: json['totalprecip_in'] as num? ?? 0,
    totalsnowCm: json['totalsnow_cm'] as num? ?? 0,
    avgvisKm: json['avgvis_km'] as num? ?? 0,
    avgvisMiles: json['avgvis_miles'] as num? ?? 0,
    avghumidity: json['avghumidity'] as num? ?? 0,
    dailyWillItRain: json['daily_will_it_rain'] as num? ?? 0,
    dailyChanceOfRain: json['daily_chance_of_rain'] as num? ?? 0,
    dailyWillItSnow: json['daily_will_it_snow'] as num? ?? 0,
...
class Hour {
  ...
  factory Hour.fromJson(Map<String, dynamic> json) => Hour(
    ...
    willItRain: json['will_it_rain'] as num? ?? 0,
    chanceOfRain: json['chance_of_rain'] as num? ?? 0,
    willItSnow: json['will_it_snow'] as num? ?? 0,
    chanceOfSnow: json['chance_of_snow'] as num? ?? 0,
    visKm: json['vis_km'] as num? ?? 0,
    visMiles: json['vis_miles'] as num? ?? 0,
